...
public class RectangleTest_getIntersectingPoints {
    ...
    @Test
    public void getIntersectingPoints_nullRectangle() {
        final Exception e = assertThrows(IllegalArgumentException.class, () -> r1.getIntersectingPoints(null));
        assertEquals("getIntersectingPoints:  rectangle cannot be null", e.getMessage());
    }

    // See intersections.png #1
    @Test
    public void getIntersectingPoints_1() {
        ...
        final Set<Point> actualIntersections = r1.getIntersectingPoints(r2);
    ...
    @Test
    public void getIntersectingPoints_2() {
        final Rectangle r2 = new Rectangle(
            new Point(13, 11),
            new Point(19, 17)
        );
    ...
    @Test
    public void getIntersectingPoints_3() {
        final Rectangle r2 = new Rectangle(
            new Point(1, 3),
            new Point(7, 8)
        );
    ...
    @Test
    public void getIntersectingPoints_4() {
        final Rectangle r2 = new Rectangle(
            new Point(13, 3),
            new Point(19, 8)
        );
    ...
    @Test
    public void getIntersectingPoints_5() {
        final Rectangle r2 = new Rectangle(
            new Point(9, 1),
            new Point(11, 15)
        );
    ...
    @Test
    public void getIntersectingPoints_6() {
        final Rectangle r2 = new Rectangle(
            new Point(2, 9),
            new Point(18, 10)
        );
        ...
        expectedIntersections.add(new Point(17, 10));
    ...
    @Test
    public void getIntersectingPoints_7() {
        final Rectangle r2 = new Rectangle(
            new Point(5, 1),
            new Point(8, 2)
        );
    ...
    @Test
    public void getIntersectingPoints_8() {
        final Rectangle r2 = new Rectangle(
            new Point(5, 0),
            new Point(8, 1)
        );
